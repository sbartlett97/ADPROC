 ...
 */
public class TypeI extends CardboardBox
{
    /**
    ...
    /**
     * Constructor for a box of type 1 as determined by the UI Class
                        ...
                        boolean sealableTopIn, double gradeMultiplierIn)
    {
        ...
        cost = calcCost(boxQuantity, baseCost, colourPrint, reinforcedBottom, 
    ...
    public double calcCost(int quantity, double baseCost, int colourPrint, boolean reinforcedBottom, boolean reinforcedCorners, boolean sealableTop){
        double testCost = super.calcCost(quantity, baseCost, colourPrint, reinforcedBottom, reinforcedCorners, sealableTop);
            return testCost / 1000;
    }
}
